        ...
        <div className='flex container mx-auto justify-between '>{/*general */}
             <div> {/*with text */}
                ...
                <div className='mt-12  flex  '> {/*btn */}
                    <p className='cursor-pointer border-2 text-lg px-6 py-1 border-[#F1DF6F] rounded-full hover:bg-[#F1DF6F]  text-black'> <Link to='/Candidate'>Выбрать кандидата</Link> </p>
